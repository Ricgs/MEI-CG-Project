...
vec3 PBR() {
    ...
    // Invertemos o Y do vetor Normal para corrigir a orientação do OpenGL
    ...
    // Invertemos o Y do vetor Refletido pela mesma razão
    ...
    vec3 prefilteredColor = textureLod(environmentMap, sampleR, DataIn.roughness * MAX_REFLECTION_LOD).rgb;
